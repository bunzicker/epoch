...
MODULE constants
  ...
  ! Each injector can open up to 9 files (in 3D)
  ! Multiple file injectors can be specified (up to custom_injector_limit)
  ! File units start at custom_base_unit, then 9 units for injector 1, the next
  ! 9 for injector 2, etc
  ! File units 10000000 to 18999999 are reserved for this routine
  ...
  INTEGER, PARAMETER :: custom_var_num = 9
  ...
  INTEGER(i8), PARAMETER :: c_def_calc_radiation = 2**28
  ...
  INTEGER, PARAMETER :: c_func_factorial = 48
  INTEGER, PARAMETER :: c_func_gen_lg_poly = 49
